<div>
    <p class="text-sm font-semibold text-gray-600 mb-4">Siapkan bahan presentasi kelompokmu. Guru akan meminta kalian menjelaskan alasan penyusunan urutan kondisi.</p>
    ...
    <textarea wire:model="tanggapanUntukKelompokLain" rows="2" class="w-full rounded-xl border-gray-200 text-sm mb-4"></textarea>
