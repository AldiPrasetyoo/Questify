<div x-data="simulasiKehadiran()">
    <p class="text-sm font-semibold text-gray-600 mb-1">Tulis program rekap kehadiran lengkap, lalu uji terhadap 4 data.
        Rekap dan persentase dicek terpisah.</p>
    <p class="text-xs font-semibold text-gray-400 mb-3">Dijalankan sungguhan lewat JSCPP — cin akan membaca nilai jam
        sesuai data uji, berurutan.</p>

    <textarea x-model="kode" rows="18"
            ...
            <table class="w-full text-sm mt-4 border rounded-2xl overflow-hidden">
                <thead class="bg-teal-50 text-left">
                    <tr>
                        ...
                        <th class="p-2 font-black">Rekap (H/T/A)</th>
                        <th class="p-2 font-black">Persentase</th>
                ...
                <tbody>
                    <template x-for="h in hasilUji" :key="h.jumlah">
                        <tr class="border-t" :class="h.lolos ? '' : 'bg-rose-50'">
                            ...
                            <td class="p-2 font-bold" :class="h.persenLolos ? 'text-emerald-600' : 'text-rose-600'"
                                x-text="h.persenLolos ? '✔' : '✘'"></td>
