...
/** Editor kode + tabel uji perulangan — dijalankan lewat JSCPP di browser */
class EditorKodeUjiPerulangan extends Component
{
    ...
    {
        return view('livewire.student.koding.editor-kode-uji-perulangan', [])->layout('layouts.questify');
    }
}
