...
class BedahKode extends Component
{
    ...
    {
        $this->bagianAktif = $index;
        $this->sudahDiketuk[$index] = true;
    }
    public function getSemuaSudahDiketukProperty(): bool
    {
        return count($this->sudahDiketuk) >= count($this->konfigurasi['bagian'] ?? []);
    }
    ...
    {
        return view('livewire.student.koding.bedah-kode', [])->layout('layouts.questify');
    }
}
