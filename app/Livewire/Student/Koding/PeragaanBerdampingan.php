...
class PeragaanBerdampingan extends Component
{
    ...
    public function lanjutSatu()
    {
        if ($this->langkah < count($this->data)) $this->langkah++;
    }
    ...
    {
        return view('livewire.student.koding.peragaan-berdampingan', [])->layout('layouts.questify');
    }
}
