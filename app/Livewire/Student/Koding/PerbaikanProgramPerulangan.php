...
/** Perbaiki program berisi 3 perulangan — dijalankan lewat JSCPP di browser */
class PerbaikanProgramPerulangan extends Component
{
    ...
    {
        return view('livewire.student.koding.perbaikan-program-perulangan', [])->layout('layouts.questify');
    }
}
