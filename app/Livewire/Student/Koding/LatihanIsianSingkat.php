...
class LatihanIsianSingkat extends Component
{
    ...
    public function getSoalAktifProperty(): array
    {
        return $this->konfigurasi['soal'][$this->indexSoal] ?? [];
    }
    ...
    {
        return view('livewire.student.koding.latihan-isian-singkat', [])->layout('layouts.questify');
    }
}
