...
class FormRumusanMasalah extends Component
{
    ...
    {
        $this->validate([
            'namaKelompok' => 'required|string', 'bentukDipilih' => 'required|string',
            'alasan' => 'required|string|min:5', 'rencanaKerja' => 'required|string|min:5',
        ]);
    ...
    public function render() { return view('livewire.student.koding.form-rumusan-masalah'); }
}
