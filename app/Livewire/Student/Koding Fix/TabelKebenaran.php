...
class TabelKebenaran extends Component
{
    ...
    public function setA(bool $nilai) { $this->a = $nilai; $this->sudahDicoba = true; }
    public function setB(bool $nilai) { $this->b = $nilai; $this->sudahDicoba = true; }
    public function getHasilContohProperty(): bool { return $this->jam > 700 && $this->jam <= 730; }
    ...
    public function render() { return view('livewire.student.koding.tabel-kebenaran'); }
}
