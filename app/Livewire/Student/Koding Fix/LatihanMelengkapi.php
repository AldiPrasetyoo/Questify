...
class LatihanMelengkapi extends Component
{
    ...
    public function getButirAktifProperty(): array { return $this->konfigurasi['butir'][$this->indexButir] ?? ['kode' => '', 'jawaban' => []]; }
    ...
    public function butirBerikutnya()
    {
        ...
        if ($this->indexButir + 1 < $total) {
            $this->indexButir++; $this->sudahDicek = false; $this->semuaBenar = false;
            return;
        }
    ...
    public function render() { return view('livewire.student.koding.latihan-melengkapi'); }
}
